...
interface GenericDataTableFacetedFilterProps<TData, TValue> {
...
export function GenericDataTableFacetedFilter<TData, TValue>({
  column,
  title,
  options,
}: GenericDataTableFacetedFilterProps<TData, TValue>) {
